// AuthX.API/Controllers/MenuController.cs
// FIX: my-menu endpoint mein bhi isOwner pass karo
...
public class MenuController : BaseController
{
    ...
    {
        // CurrentCompanyId: Owner ke liye X-Owner-CompanyId header se override hota hai
        var menu = await _svc.GetMenuForUserAsync(
            CurrentCompanyId,
            CurrentUserRoles,
            isOwner: IsOwner);  // KEY: Owner = saare menus
    ...
    public async Task<IActionResult> GetAll()
    {
        if (IsOwner)
            ...
            return OkResult(await _svc.GetAllowedMenuItemsAsync(CurrentCompanyId, CurrentUserId));
    }
